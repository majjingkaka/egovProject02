...
public class EgovWebApplicationInitializer implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		if("security".equals(EgovProperties.getProperty("Globals.Auth").trim())) {
			...
			egovSpringSecurityLoginFilter.setInitParameter("loginURL", "/bible/bibleLogin/login.do");
			
			//로그인 처리 URL설정
			egovSpringSecurityLoginFilter.setInitParameter("loginProcessURL", "/uat/uia/actionLogin.do");
			//egovSpringSecurityLoginFilter.setInitParameter("loginProcessURL", "/bible/bibleLogin/toLogin.do");
